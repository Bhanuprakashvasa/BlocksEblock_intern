...
console.log(`Description: Miner ${powWinner.id} will validate the next block with power ${powWinner.power} at 11:15 AM IST, June 09, 2025.`);
...
console.log(`Description: Staker ${posWinner.id} will validate with a stake of ${posWinner.stake} coins at 11:15 AM IST, June 09, 2025.`);

const dposCandidates = ['Alice', 'Bob', 'Charlie', 'David', 'Eve']; // Added two more candidates
...
console.log(`Description: ${dposWinner} will serve as a delegate with ${voteCounts[dposWinner]} votes at 11:15 AM IST, June 09, 2025.`);